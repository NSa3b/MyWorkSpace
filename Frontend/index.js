...
// ________________________List API calling_______________________
...
// ________________________Task API Calling_______________________
...
function oninit(){
    ...
    document.addEventListener("click",async function(event){
        ...
        if(event.target.matches("#deletelistbtn")){
            let Listid=document.getElementById("chosenList").value;
            console.log(Listid);
            let alltasks= await getTaskbyListid(Listid).then((alltasks)=>{
    ...
    addTaskbtn.addEventListener("click", async function(){
        ...
        let taskstoshow=await getTaskbyListid(chosenListid);
